...
public:
     ...
     bool graspObject(ModelData& data);
...
private:
    ...
    rw::math::Transform3D<double>	 _approach_pose;
    rw::math::Transform3D<double>	 _grasp_pose;
    rw::math::Transform3D<double>	 _retract_pose;
    rw::math::Q				 _Q_grasp;
    rw::math::Q				 _Q_start;
