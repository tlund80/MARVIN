...
public:
	Path_optimization(boost::shared_ptr<dti::grasp_planning::Workcell> workcell, boost::shared_ptr<OptimizationConfiguration> Config);
...
private:
	...
	public:
		...
		void init(ClearanceConfig* config, dti::grasp_planning::Workcell *workcell);
		void optimize(rw::trajectory::Path<rw::math::Q> &path);

	private:
		dti::grasp_planning::Workcell *_workcell;
		double _stepsize;
		int _max_count;
		double _max_time;
	};
	...
	public:
		...
		void init(PathLengthConfig* config, dti::grasp_planning::Workcell *workcell);
		void optimize(rw::trajectory::Path<rw::math::Q> &path);
	...
	boost::shared_ptr<dti::grasp_planning::Workcell> _workcell;
